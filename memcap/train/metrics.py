...
from proj_utils.coco_caption.pycocoevalcap.bleu.bleu import Bleu
from proj_utils.coco_caption.pycocoevalcap.rouge.rouge import Rouge
from proj_utils.coco_caption.pycocoevalcap.cider.cider import Cider
from proj_utils.coco_caption.pycocoevalcap.meteor.meteor import Meteor


parser = argparse.ArgumentParser( description="""This takes two text files and a path the references (source, references),
